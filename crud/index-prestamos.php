        ...
        <table>
            ...
            <tbody>
                <?php while ($row = mysqli_fetch_array($query)): ?>
                    <tr>
                        <th><?= $row['id'] ?></th>
                        <th><?= $row['pelicula_id'] ?></th>
                        <th><?= $row['usuario_id'] ?></th>
                        <th><?= $row['fecha_prestamo'] ?></th>
                        <th><?= $row['fecha_devolucion'] ?></th>
                        
                        <th><a href="actualizar_prestamos.php?id=<?= $row['id'] ?>" class="table--edit">Editar</a></th>
                        <th><a href="eliminar_prestamos.php?id=<?= $row['id'] ?>" class="table--delete" >Eliminar</a></th>
                    </tr>
                <?php endwhile; ?>
            </tbody>
        </table>
